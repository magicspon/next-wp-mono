...
export const variants = cva(null, {
	variants: {
		intent: {
			subHeading: 'text-2xl sibling:mb-3',
			heading: 'text-6xl sibling:mb-10',
			lead: 'text-xl sibling:mb-5',
			normal: 'text-base sibling:mb-4',
			small: 'text-sm sibling:mb-4',
		},
	...
	compoundVariants: [
		{
			family: 'title',
			intent: 'subHeading',
			className: 'text-accent uppercase md:absolute left-0 top-0',
		},
	],
	defaultVariants: {
		intent: 'normal',
...
export const banner: TBlockStyle = {
	heading: ({ children }) => (
