...
export const variants = cva(null, {
	variants: {
		intent: {
			subHeading: 'text-sm sibling:mb-3',
			heading: 'text-2xl sibling:mb-6',
			lead: 'text-lg sibling:mb-5',
	...
	compoundVariants: [
		{
			...
			intent: 'subHeading',
			className:
				'bg-accent text-accent-foreground px-2 py-0.5 rounded-full inline-flex uppercase',
		},
	],
	defaultVariants: {
		intent: 'normal',
